...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right Panel - Visual */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary via-purple-600 to-primary items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-primary-foreground/80 max-w-md">
            Leads, tickets, workflows, and more. Zivux.ai brings your entire 
            customer journey together in one powerful platform.
          </p>
        </motion.div>
      </div>
    </div>
