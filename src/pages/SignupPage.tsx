...
import { Zap, ArrowRight, Mail, Lock, Eye, EyeOff, User, Building2 } from "lucide-react";
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Visual */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-accent via-info to-accent items-center justify-center p-12 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="relative text-center text-accent-foreground"
        >
          ...
          <p className="text-accent-foreground/80 max-w-md">
            14 days free, no credit card required. Experience the power of 
            omnichannel CRM management.
          </p>
